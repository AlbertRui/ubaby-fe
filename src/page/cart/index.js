...
var page = {
    ...
    showCartError: function () {
        _ubaby.showErrorMessage('.page-wrap','哪里不对了，刷新一下吧~~>_<~~');
    },
    bindEvent: function () {
        var _this = this;
        // 商品选择/取消选择
        ...
        $(document).on('click', '.cart-delete', function () {
            var $this = $(this);
            _ubaby.confirmTips('确认要删除该商品吗？', function () {
        ...
        $(document).on('click', '.delete-selected', function () {
            _ubaby.confirmTips('确认要删除选中的商品吗？', function () {
                var arrProductIds = [],
    ...
    renderCart: function (data) {
        ...
        var cartHtml = _ubaby.renderHtml(templateHtml, data);
