 ...
 * @Last Modified time: 2018-07-23 19:50:02
 */
'use strict';
...
var addressModal = {
    ...
    loadModal: function () {
        var modalHtml = _ubaby.renderHtml(templateAddressModal, {
    ...
    bindEvent: function () {
        ...
        this.$modalWrap.find('.address-btn').click(function () {
            ...
            if (!isUpdate && receiverInfo.status) {
                ...
                //验证不通过
                _ubaby.errorTips(receiverInfo.errMsg || '好像哪里不对了~~>_<~~');
            }
        });
        //拦截事件
